              ...
              <thead className="bg-[#ECECEC]">
                <tr>
                  {[
                    ...
                    <th
                      key={header}
                      className="px-6 py-4 font-semibold text-[#081E37] text-xs border-b border-gray-200"
                    >
                      {header}
                    </th>
                  ))}
              ...
              <tbody className="divide-y divide-gray-200">
                {students.map((student) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-[#535862] font-medium whitespace-nowrap">
                      {student.name}
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${student.subscribed ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                      >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-medium ${student.status === "Active" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                      >
                        {student.status}
                      </span>
                    </td>
            ...
            {students.map((student) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h4 className="font-semibold text-[#535862] text-base">
                      {student.name}
                    </h4>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <span
                      className={`ml-2 px-2 py-0.5 rounded-full text-xs font-medium ${student.status === "Active" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                    >
                      {student.status}
                    </span>
                  </div>
                ...
                <div className="mt-3">
                  ...
                  <span
                    className={`ml-2 px-3 py-1 rounded-full text-xs font-medium ${student.subscribed ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                  >
                    {student.subscribed ? "Yes" : "No"}
                  </span>
                </div>
