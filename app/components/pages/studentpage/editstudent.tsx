...
const EditStudent: React.FC = () => {
  ...
  if (!formData) return <p className="text-center py-10 text-gray-500">Student not found</p>;
  ...
  return (
    <div className="min-h-screen bg-white p-4 sm:p-6 lg:p-8"> {/* এখানে প্যাডিং রেসপন্সিভ */}
      <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-6">Student Management</h2>

      {/* মূল কার্ড – ফিক্সড উইড্থ সরিয়ে max-w দিলাম */}
      <div className="bg-[#F5F7FB] mx-auto max-w-5xl rounded-lg shadow-sm border-2 border-blue-500 p-4 sm:p-6 lg:p-8">
        
        <div className="mb-8">
          <h3 className="text-base font-medium text-gray-700 mb-6">General Information</h3>
        ...
        {/* গ্রিড রেসপন্সিভ করলাম – মোবাইলে ১ কলাম, বড় স্ক্রিনে ২ কলাম */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Subscribed */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Subscribed</label>
            <input
              type="text"
